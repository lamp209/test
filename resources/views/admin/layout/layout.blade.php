        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li>
                        <a href="/admin/#"><i class="icon-list"></i> Forms</a>
                        <ul>
                            <li><a href="/admin/form_layouts.html">Layouts</a></li>
                            <li><a href="/admin/form_elements.html">Elements</a></li>
                            <li><a href="/admin/form_wizard.html">Wizard</a></li>
                        </ul>
                    </li>
